        ...
        <div className="max-w-4xl">
          ...
          <Reveal delay={200} y={30}>
            <div className="mt-4 -ml-1 relative inline-block">
              ...
              <div
                className="absolute -inset-6 md:-inset-10 -z-10 rounded-full opacity-65 blur-2xl md:blur-3xl pointer-events-none select-none"
                style={{
                  background:
                    "radial-gradient(ellipse at center, rgba(220, 235, 255, 0.40) 0%, rgba(140, 180, 255, 0.16) 45%, rgba(0, 0, 0, 0) 75%)",
                }}
              />
              <img
                src="/images/rausch-logo.png"
                alt="RAUSCH"
                className="relative z-10 w-[88vw] sm:w-[74vw] md:w-[62vw] lg:w-[48rem] max-w-full h-auto object-contain select-none drop-shadow-[0_0_35px_rgba(220,235,255,0.30)]"
              />
            </div>
          </Reveal>
